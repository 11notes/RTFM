...
# TL;DR - FOR BEGINNERS
Named volumes are the easiest way to work with persistent data and containers. They do all the heavy lifting for you. Use them by default! Do not use bind mounts, only use them if you have no other option availabile to you and even then, use them declared as a named volume!
